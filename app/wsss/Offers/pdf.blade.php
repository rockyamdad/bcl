        ...
        <div class="t01-01" id="inv">
            ...
            <div id="inv_top">
                ...
                <div id="inv_logo">
                    ...
                    <table  cellspacing="0" cellpadding="4" id="inv_box">
                        ...
                        <tr>
                            ...
                            <td>{{ $offerdata->price + ($offerdata->price * ($offerdata->commission/100)) }}</td>
                        </tr>
                        <tr>
                            <th>Commission #:
                            </th>
                            <td>{{ $offerdata->price * ($offerdata->commission/100) }}</td>
                        </tr>
                        <tr>
                            <th>Date:</th>
                ...
                <div class="inv_topspace">
                    <!--            <img width="1" height="1" alt="" src="https://fb-assets.com/images/spacer.gif">-->
                </div>
                ...
                <table cellspacing="0" cellpadding="2" width="100%" id="inv_items">
                    ...
                    <tr>
                       ...
                       <tr>
                            ...
                            <td class="inv_col_desc">{{$offerdata->description}}</td>
                            <td class="inv_col_cost">{{$offerdata->price}}</td>
                            <td class="inv_col_qty">{{$offerdata->commission}}</td>
                            <td class="inv_col_qty">{{ $offerdata->price + ($offerdata->price * ($offerdata->commission/100)) }}</td>
                        </tr>
